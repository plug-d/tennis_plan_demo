...
FACILITIES = {
    "市民テニスコートA": {
        "address": "東京都○○区△△1-1-1",
        "url": "https://example.com/facilityA",
    },
    "市民テニスコートB": {
        "address": "東京都○○区□□2-2-2",
        "url": "https://example.com/facilityB",
    },
    "総合スポーツ公園": {
        "address": "東京都○○区◇◇3-3-3",
        "url": "https://example.com/facilityC",
    },
}
...
def make_sample_df() -> pd.DataFrame:
    ...
    # ---- 過去データ（実績グラフ用）----
    past = [
        (-175, "市民テニスコートA", "オムニ",  10, 12, ["メンバーA","メンバーB","メンバーC","メンバーD"], 4),
        (-160, "市民テニスコートB", "ハード",   14, 16, ["メンバーA","メンバーC","メンバーE"],             6),
        (-145, "市民テニスコートA", "オムニ",  10, 12, ["メンバーA","メンバーB","メンバーD","メンバーE","メンバーF"], 6),
        (-130, "総合スポーツ公園",  "クレー",   9,  11, ["メンバーA","メンバーB","メンバーC"],             6),
        (-115, "市民テニスコートA", "オムニ",  21, 22, ["メンバーA","メンバーC","メンバーD"],             4),
        (-100, "市民テニスコートB", "ハード",   14, 16, ["メンバーA","メンバーB","メンバーC","メンバーD","メンバーE","メンバーF"], 6),
        (-85,  "市民テニスコートA", "オムニ",  10, 12, ["メンバーA","メンバーB","メンバーD"],             4),
        (-70,  "市民テニスコートA", "オムニ",  21, 22, ["メンバーA","メンバーC","メンバーE","メンバーF"], 4),
        (-55,  "総合スポーツ公園",  "クレー",   9,  11, ["メンバーA","メンバーB","メンバーC","メンバーD"], 6),
        (-40,  "市民テニスコートA", "オムニ",  10, 12, ["メンバーA","メンバーB","メンバーE"],             4),
        (-25,  "市民テニスコートB", "ハード",   14, 16, ["メンバーA","メンバーC","メンバーD","メンバーF"], 6),
        (-10,  "市民テニスコートA", "オムニ",  21, 22, ["メンバーA","メンバーB","メンバーC","メンバーD"], 4),
    ]
